        ...
        var ret = new ResponsePageDto<IFriend>()
        {
            ...
            .Where(i => (i.Seeded == seeded) &&
                        (i.FirstName.ToLower().Contains(filter) ||
                            i.LastName.ToLower().Contains(filter)) || i.AddressDbM.Country.ToLower().Contains(filter) || i.AddressDbM.City.ToLower().Contains(filter)).CountAsync(),
            ...
            .Where(i => (i.Seeded == seeded) &&
                        (i.FirstName.ToLower().Contains(filter) ||
                            i.LastName.ToLower().Contains(filter)) || i.AddressDbM.Country.ToLower().Contains(filter) || i.AddressDbM.City.ToLower().Contains(filter))
