...
function clickHandler (event)  {
    ...
    let elems = document.querySelectorAll('input[data-delete-item-id-target]');
    elems.forEach(elem => {
...
//Add clickHandler to all tags that define the data property data-delete-item-id
let selems = document.querySelectorAll('*[data-delete-item-id]');
selems.forEach(elem => {
